...
#str_durchsatz = arr_input_values[1]
#str_viscosity = arr_input_values[2]

# MEDIUM

#str_medium = arr_input_values_2[1]
#split(str_medium, arr_medium, "!!")
#print str_medium "\n"   >> errlog_txt
#for (i=1; i<=length(arr_medium); i++) {
#  print i " - " arr_medium[i]  >> errlog_txt
#}
#print "\n"   >> errlog_txt
#
#split(arr_medium[1],arr_medium1,"__")
#label_for_medium = arr_medium1[1]
#split(arr_medium[2],arr_medium1,"__")
#medium_header = arr_medium1[1]

print_bootstrap_head()

print "<input type=\"hidden\" name=\"general_limits\" value=\"" gen_limits_hidden "\">\n"  >> result_txt
...
print_dropdown(k=2) # 2 = ANTRIEB
print_input(mystart=9, myend=10) # utempmin, utempmax

print_dropdown(k=3) # 3 = Filtermaterial
print_dropdown(k=4) # 4 = MAterial Element
...
print "AUTOMATIC FILTER SIZING /// 1 Versuch )</div>"  >> result_txt
