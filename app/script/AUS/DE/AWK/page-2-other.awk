...
if (comments == "ON") {
   print "<BR><i>Input Information" >> result_txt
   for (i=1; i<=length(arr_for_str_input); i++)
      print "<BR>arr_for_str_input["i"]: " arr_for_str_input[i] >> result_txt
   print "<BR>Param, min, max, step: " str_ivalues >> result_txt
   print "<BR>Comments: " comments "</i></BR>." >> result_txt
}
