...
END {
  if (found == 0) {  
     ...
     print mt "#### Außenanstrich: Rostschutzfarbe WITH CODE [" ft "] NOT FOUND IN DB"  >> TMP_DIR "/" UUID ".result.txt"
     print mt "Err.code 0706 - Außenanstrich: Rostschutzfarbe WITH CODE [" ft "] NOT FOUND IN DB" >> TMP_DIR "/" UUID ".errlog.txt"
  }
