...
#print "Filter ser :" filter_series_search >> "result.txt"
#print "Filter rep :" filter_series_report >> "result.txt"
...
func find_eef(fn_slash) {
  ...
  einsatz   = arr_tmp1[4]
  paint     = arr_tmp1[3] arr_tmp1[4] arr_tmp1[5]
